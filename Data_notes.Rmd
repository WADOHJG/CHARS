...
* The external causes of injury and poisoning (E-codes: E800-E999) for ICD-9-CM and the external causes of morbidity (V, W, X, Y codes: V01-Y99) are not listed in diagnosis conditions in CHARS and the single-level CCS categories 260 and 2601-2621 for external cuases codes are excluded.

####  Medical Expenditure Panel Survey (MEPS) Condition Categories
MEPS conditon categories group single-level CCS categories into 61 broader categories. This table [[link](http://www.meps.ahrq.gov/mepsweb/data_stats/conditions.shtml)] shows the CCS codes that make up each category.Decisions about collapsing CCS categories were based on maintaining the clinical significance of categories, the ability of MEPS respondents to report the condition accurately, and the frequency of reporting the condition. The category 'Residual codes' (the corresponding CCS cateogry 259 'Residual codes; unclassified') was excluded in the report.
